        ...
        <div className="flex flex-1 flex-col gap-10 p-6 md:p-10 max-w-3xl mx-auto w-full">
          ...
          <section>
            ...
            <p className="text-muted-foreground text-lg leading-7">
              Integrate Notch counters into your site with a few lines of code. All public endpoints are rate limited to prevent abuse. A <code className="text-primary font-mono bg-muted px-1 py-[.2rem] rounded">public_key</code> is the public key generated with your counter, that can be copied in the dashboard.
            </p>
          </section>
  ...
  {/* Tips Section */}
          <section className="bg-muted/50 rounded-xl p-8 border border-border mb-10">
            ...
            <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
              Using React? Here is a simple way to fetch and display your live count. This example uses <code className="text-primary font-mono bg-muted px-1 py-[.2rem] rounded">useEffect</code> to load the data when your component mounts.
            </p>
...
const CounterDisplay = () => {
    ...
    useEffect(() => {
        fetch("https://notch.up.railway.app/api/counters/public/notch_pub_b6sUE5TnWYTKMJJnt4cQRtZYXk4NjQtW")
            .then((res) => res.json())
            .then((data) => {
